...
bs = nd_co_ocus["baseline I-I"] + nd_co_ocus["baseline O-O"] + nd_co_ocus["baseline I-O"]
st = nd_co_ocus["sota I-I"]     + nd_co_ocus["sota O-O"]     + nd_co_ocus["sota I-O"]
gd = nd_co_ocus["golden I-I"]   + nd_co_ocus["golden O-O"]  + nd_co_ocus["golden I-O"]
...
print ("ALL baseline %.4f" % ((bs - gd) ** 2).sum() ** 0.5)
print ("ALL sota     %.4f" % ((st - gd) ** 2).sum() ** 0.5)
viz.heatmap(
	X = bs,
	opts = dict(
		colormap = "Electric",
